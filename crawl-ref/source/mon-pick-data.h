...
{ // Dungeon (OOD cap: 27). Orcs, goblins, trolls, giants, undead (?)
  ...
  {  1,  8,  335, SEMI, MONS_JACKAL },
  {  1,  9,  400, PEAK, MONS_GNOLL },
  ...
  {  3, 10,   200, SEMI, MONS_GNOLL_SHAMAN },
  //{  4, 10,  136, SEMI, MONS_ORC_PRIEST },
  //{  3,  8,  925, FLAT, MONS_WORKER_ANT },
  {  4,  9,  825, SEMI, MONS_HOUND },
  {  3, 11,  825, SEMI, MONS_OGRE },
  ...
  {  5, 10,   200, PEAK, MONS_GNOLL_SERGEANT },
  ...
  { 9, 15,  150, SEMI, MONS_MELIAI },
  { 9, 15,   89, PEAK, MONS_RAKSHASA },
  { 10, 15,  925, FLAT, MONS_CENTAUR_WARRIOR },
  { 11, 15,  925, FALL, MONS_CENTAUR_WARRIOR },
