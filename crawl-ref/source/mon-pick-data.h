...
{ // Dungeon (OOD cap: 27). Orcs, goblins, trolls, giants, undead (?)
  //{ -2,  6,  515, SEMI, MONS_GIANT_COCKROACH },
  //{ -2,  6,  192, PEAK, MONS_BALL_PYTHON },
  //{ -1,  4,  640, SEMI, MONS_FRILLED_LIZARD},
  //{ -1,  5,  136, SEMI, MONS_OOZE },
  {  1,  2, 1000, FLAT, MONS_GOBLIN },
  //{  1,  2, 1000, FLAT, MONS_BAT },
  {  1,  2, 1000, FLAT, MONS_KOBOLD },
  //{  1,  2, 1000, FLAT, MONS_RAT },
  {  1,  2, 1000, FLAT, MONS_HOBGOBLIN },
  //{  1,  4,  335, FALL, MONS_DART_SLUG },
  //{  1,  8,  515, SEMI, MONS_LEOPARD_GECKO },
  {  1,  3,  335, SEMI, MONS_JACKAL },
  {  2,  5,  400, PEAK, MONS_GNOLL },
  //{  2,  8,  925, FLAT, MONS_ADDER },
  ...
  {  2, 6,   400, SEMI, MONS_GNOLL_SHAMAN },
  //{  4, 10,  136,  , MONS_ORC_PRIEST },
  //{  3,  8,  925, FLAT, MONS_WORKER_ANT },
  {  2,  5,  825, SEMI, MONS_HOUND },
  {  3,  6,  825, SEMI, MONS_OGRE },
  //{  4, 11,  515, SEMI, MONS_IGUANA },
  //{  4, 10,  515, SEMI, MONS_ORC_WIZARD },
  //{  4,  9,  515, SEMI, MONS_SCORPION },
  //{  4, 10,  335, SEMI, MONS_PHANTOM },
  //{  4, 14,  335, SEMI, MONS_HOWLER_MONKEY },
  //{  4, 16, 1000, FLAT, MONS_SKELETON },
  {  3, 6,   400, PEAK, MONS_GNOLL_SERGEANT },
  //{  4,  8,  650, FLAT, MONS_CRIMSON_IMP },
  //{  4,  8,  350, FLAT, MONS_SHADOW_IMP },
  {  3, 6,  825, SEMI, MONS_CENTAUR },
  //{  4, 15,  515, SEMI, MONS_ICE_BEAST },
  //{  5, 15,  515, SEMI, MONS_JELLY },
  //{  5, 15,  515, SEMI, MONS_SKY_BEAST },
  //{  3,  9,  192, PEAK, MONS_NECROPHAGE },
  //{  4, 10,  192, PEAK, MONS_QUASIT },
  //{  5, 15,  192, PEAK, MONS_WATER_MOCCASIN },
  //{  5, 16, 1000, FLAT, MONS_ZOMBIE },
  //{  6, 13,  285, SEMI, MONS_BLACK_BEAR },
  //{  5, 16, 1000, FLAT, MONS_BULLFROG },
  //{  6, 16,  825, SEMI, MONS_ORC_WARRIOR },
  //{  5, 16,  335, SEMI, MONS_WIGHT },
  {  6, 16,  335, SEMI, MONS_NO_MONSTER }, // Old ballistomycete spore weight.
  {  3, 6,   415, SEMI, MONS_BIG_KOBOLD },
  //{  7, 13,  470, SEMI, MONS_KILLER_BEE },
  //{  7, 15,   89, PEAK, MONS_STEAM_DRAGON },
  //{  7, 17,  615, SEMI, MONS_HIPPOGRIFF },
  //{  7, 17,  350, SEMI, MONS_NO_MONSTER },
  //{  6, 17,  192, PEAK, MONS_CROCODILE },
  //{  7, 17,  192, PEAK, MONS_HORNET },
  {  5, 6,  675, FLAT, MONS_TWO_HEADED_OGRE },
  //{  8, 18,  335, SEMI, MONS_WYVERN },
  //{  8, 18,  230, PEAK, MONS_EYE_OF_DRAINING },
  //{  8, 14,  825, SEMI, MONS_YAK },
  {  5, 6,  825, FLAT, MONS_TROLL },
  //{  9, 19,  192, PEAK, MONS_VAMPIRE },
  //{ 10, 16,  194, PEAK, MONS_SOLDIER_ANT },
  //{ 10, 18,  370, SEMI, MONS_GARGOYLE },
  //{ 10, 18,  335, SEMI, MONS_WRAITH },
  //{  8, 20,  515, SEMI, MONS_UNSEEN_HORROR },
  //{  9, 20,  192, PEAK, MONS_KOMODO_DRAGON },
  //{  8, 18,  235, SEMI, MONS_KOBOLD_DEMONOLOGIST },
  //{ 10, 18,  750, FLAT, MONS_UGLY_THING },
  //{ 10, 21,  520, SEMI, MONS_MANTICORE },
  { 6, 6,  825, FLAT, MONS_CYCLOPS },
  //{  9, 21,  380, SEMI, MONS_SHADOW },
  //{  9, 21,  335, SEMI, MONS_ACID_DRAGON },
  //{  9, 21,  260, PEAK, MONS_BASILISK },
  //{ 10, 21,  192, PEAK, MONS_SKELETAL_WARRIOR },
  //{ 11, 21,  192, PEAK, MONS_DEATH_KNIGHT },
  //{  9, 23,  515, SEMI, MONS_HYDRA },
  //{ 11, 19,  475, SEMI, MONS_DEEP_ELF_MAGE },
  //{ 11, 20,  500, SEMI, MONS_VAMPIRE_MOSQUITO },
  //{  9, 22,  440, FALL, MONS_SLIME_CREATURE },
  { 5,  6,  150, SEMI, MONS_MELIAI },
  //{ 9, 15,   89, PEAK, MONS_RAKSHASA },
  { 6, 6,  925, FLAT, MONS_CENTAUR_WARRIOR },
  { 6, 6,  925, FALL, MONS_CENTAUR_WARRIOR },
  ...
  //{ 10, 15,  136, SEMI, MONS_FIRE_GIANT },
  //{ 10, 15,  136, SEMI, MONS_FROST_GIANT },
  //{ 21, 27,   25, PEAK, MONS_ORC_SORCERER },
  //{ 10, 15,  310, FALL, MONS_STONE_GIANT },
  //{ 10, 15,  192, PEAK, MONS_ETTIN },
...
{ // Depths (OOD cap: 14)
  ...
  {  3, 14,   50, FLAT, MONS_JUGGERNAUT },
  //{  5, 14,   50, FLAT, MONS_CAUSTIC_SHRIKE },
  {  4, 14,   50, FLAT, MONS_TITAN },
