...
{ // Dungeon (OOD cap: 27). Orcs, goblins, trolls, giants, undead (?)
  ...
  {  2,  2,  300, FLAT, MONS_NECROPHAGE },
  {  2,  2,  100, FLAT, MONS_PHANTOM },
  ...
  {  4,  4,  825, FLAT, MONS_CENTAUR },
  {  4,  4,  600, FLAT, MONS_ORC_WARRIOR },
  {  4,  4,  600, FLAT, MONS_ORC_PRIEST },
  {  4,  4,  600, FLAT, MONS_ORC_WIZARD },
  {  4,  4,  825, FLAT, MONS_HOUND },
  {  4,  4,  300, FLAT, MONS_OGRE },
  // D5: The Lair and Orc. Animals and orcses!
  {  5,  5,  825, FLAT, MONS_ORC_WARRIOR },
  {  5,  5,  600, FLAT, MONS_ORC_PRIEST },
  {  5,  5,  600, FLAT, MONS_ORC_WIZARD },
  {  5,  5,  500, FLAT, MONS_OGRE },
  {  5,  5,  345, FLAT, MONS_ORC_KNIGHT },
  {  5,  5,  260, FLAT, MONS_BASILISK },
  {  5,  5, 1000, FLAT, MONS_PORCUPINE },
  {  5,  5,  400, FLAT, MONS_CROCODILE },
  {  5,  5,  300, FLAT, MONS_YAK },
  // D6: The Depths and its environs. Horrible giants!
  {  6,  6,  500, FLAT, MONS_OGRE },
  {  6,  6,  675, FLAT, MONS_TWO_HEADED_OGRE },
  {  6,  6,   50, SEMI, MONS_FIRE_GIANT },
  {  6,  6,   50, FLAT, MONS_FROST_GIANT },
  {  6,  6,   50, FALL, MONS_STONE_GIANT },
  {  6,  6,  192, FLAT, MONS_ETTIN },
  {  6,  6,  825, FLAT, MONS_TROLL },
  {  6,  6,  200, FLAT, MONS_DEEP_TROLL },
  {  6,  6,  500, FLAT, MONS_CYCLOPS },
  {  6,  6,  335, FLAT, MONS_YAKTAUR },
  { 0,0,0,FLAT,MONS_0 }
};
