...
BRANCH_EXIT(DNGN_EXIT_DWARF, "staircase back to the Snake Pit", "exit_dwarven_hall"),
BRANCH_EXIT(DNGN_EXIT_FOREST, "staircase back to the Vaults", "exit_forest"),
BRANCH_EXIT(DNGN_EXIT_BLADE, "staircase back to the Shoals", "exit_hall_of_blades"),
#endif
